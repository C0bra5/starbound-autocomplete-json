Based on the [autocomplete-json](https://atom.io/packages/autocomplete-json) package, this is a modified version of the original package made to help with starbound mod developpement.
