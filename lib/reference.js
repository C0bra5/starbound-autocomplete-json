...
export default class Reference{
	...
	format(){
		...
		switch (this.type) {
			case CONSTS.DATATYPE_OBJECT:
				sugg.snippet = this.name + "\" : \{	\n\t${1:null}\n\},";
				break;
			case CONSTS.DATATYPE_ARRAY:
				sugg.snippet = this.name + "\" : \[	\n\t${1:null}\n\],";
				break;
			case CONSTS.DATATYPE_STRING:
				sugg.snippet = this.name + "\" : \"$1\",";
				break;
			case CONSTS.DATATYPE_BOOLEAN:
				sugg.snippet = this.name + "\" : ${1:false},";
				break;
			case CONSTS.DATATYPE_BOOLEAN2:
				sugg.snippet = this.name + "\" : ${1:true},";
				break;
			case CONSTS.DATATYPE_INTEGER:
				sugg.snippet = this.name + "\" : ${1:1},";
				break;
			case CONSTS.DATATYPE_INTEGER2:
				sugg.snippet = this.name + "\" : ${1:0},";
				break;
			case CONSTS.DATATYPE_FLOAT:
				sugg.snippet = this.name + "\" : ${1:0.0},";
				break;
			default:
				sugg.text = this.name;
				break;
