...
export const reusableDocumentation = {
	...
	"projectile" : {
		"∏∏suggestions" : {
			...
			"damageKindImage" : { "dataType" : "path", "description" : "Sets the icon for the damage kind." },
			      ...
			      "flippable" : { "dataType" : "float", "description" : "Wether or not the projectile visual can be flipped if it goes upside down." },
			"orientationLocked" : { "dataType" : "float", "description" : "Wether or not the projectile visual can be flipped if it goes upside down." }
		},
		"damageKindImage" : {
			"∏∏suggestions" : {
	...
	"statusEffects" : {
		"∏∏suggestions" : "statusEffects"
	},
	"damageSourceKind" : {
		"∏∏suggestions" : "damageSourceKind"
	},
	"tooltipKind" : {
		"∏∏suggestions" : {
